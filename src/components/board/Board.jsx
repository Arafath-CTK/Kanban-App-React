...
import { addTask, updateTaskStatus } from "../../Redux/Reducer/Reducer";
  ...
  return (
    <DragDropContext onDragEnd={handleDragEnd}>
      <div className="flex flex-col p-10">
        ...
        >
          <h1 className="text-2xl sm:text-4xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-4xl text-center font-bold text-slate-500">
            Kanban Board
          </h1>
        </div>
